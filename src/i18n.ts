...
const ZH_CN = {
    ...
    less: "少",
    more: "多",
    totalCount: "共 ${docs} 个文档，${count} 个块",
    cellTooltip: "${date}：${docs} 个文档，${count} 个块",
...
const ZH_TW: I18n = {
    ...
    less: "少",
    more: "多",
    totalCount: "共 ${docs} 個文檔，${count} 個區塊",
    cellTooltip: "${date}：${docs} 個文檔，${count} 個區塊",
    legendTooltipZero: "0 個區塊",
    legendTooltipExact: "${count} 個區塊",
    legendTooltipRange: "${min}–${max} 個區塊",
    legendTooltipMore: "${min}+ 個區塊",
    legendTooltipUnused: "未使用",
    settings: "設定",
    statMode: "統計方式",
    ...
    levelsHintPercentile: "按有活動日期的區塊數分位劃分 1–4 級，預設 25 / 50 / 75",
    levelsHintCount: "按絕對區塊數劃分 1–4 級，預設 1 / 10 / 40",
    levelsReset: "恢復預設",
    cancel: "取消",
    confirm: "確定",
    back: "返回",
    dayEmpty: "該日暫無文檔",
    daySummary: "${docs} 篇文檔，共 ${blocks} 個區塊",
    dayDocsTruncated: "僅顯示前 ${count} 篇文檔",
    docBlockCount: "${count} 個區塊",
...
const JA: I18n = {
    ...
    less: "少",
    more: "多",
    totalCount: "合計 ${docs} ドキュメント、${count} ブロック",
    cellTooltip: "${date}：${docs} ドキュメント、${count} ブロック",
    ...
    colorHint: "日付が見やすいよう、極端な明暗は制限しています",
...
const EN: I18n = {
    ...
    less: "Less",
    more: "More",
    totalCount: "${docs} docs, ${count} blocks in total",
    cellTooltip: "${date}: ${docs} docs, ${count} blocks",
    ...
    colorHint: "Extreme light/dark values are limited so dates stay readable",
